...
async def on_ready():
    ...
    await client.change_presence(status = discord.Status.online, activity = discord.Game('(!도움말 로 시작하기)끝말잇기 준비'))
...
async def on_message(message):
    ...
    if message.content in ['!끝말', '!끝말잇기', '!끝말카드', '!도움말']:


        if '!도움말' == message.content:
        ...
        await client.change_presence(status = discord.Status.online, activity = discord.Game('끝말잇기'))
